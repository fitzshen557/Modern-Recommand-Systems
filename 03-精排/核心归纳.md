...
| 方法 | 机构 | 年份 | 核心思想 | 链接 |
|------|------|------|----------|------|
| **GenRank** | 小红书 | 2025 | 面向动作的序列组织 + 线性时空偏置，训练加速94.8%，P99延迟降低25%+ | [论文](https://arxiv.org/abs/2505.04180) \| [详解](./解读/04-GenRank.md) |
...
2. **生成式精排落地**：GenRank（小红书2025）在 Explore Feed 验证了生成式精排的大规模可行性，核心是面向动作的序列组织（序列长度减半→训练加速94.8%）
...
**2026-09-17**
- [arxiv 2607.24804] Bumblebee: Interleaved Mixed-Layer Building Blocks for Large-Scale Recommendation Systems — 大规模推荐系统的交错混合层构建块，新型模型架构设计（https://arxiv.org/abs/2607.24804）
- [arxiv 2609.18695] SURF: Subtractive Updates for Recommender Forgetting — 推荐系统中的减法更新遗忘机制，让推荐系统学会「忘记」（https://arxiv.org/abs/2609.18695）
- [arxiv 2609.16625] AURA: Agentic Diagnosis and Refinement for Production Recommender Systems at Scale (RecSys'26 Workshop) — 大规模生产推荐系统的智能体诊断与优化，Agent for RecSys新方向（https://arxiv.org/abs/2609.16625）

**2026-09-16**
- [arxiv 2609.16407] Balancing Trial and Reorder: A Hybrid Sequential Transformer-GBDT Ranker for On-Demand Delivery — 提出Transformer-GBDT混合排序器，V1/V2/V3迭代提升Merchant Trial Rate +5.5%/+0.45%/+1.31%，跨域统一餐厅与零售排序器（https://arxiv.org/abs/2609.16407）

**2026-08-09**
- [arxiv 2608.06213] Gryphon-v2: One Model in Place of a Cascade — 用单一Generate-and-Rank模型替代传统级联排序管线，通过Rollout Distillation训练，自回归生成候选排名（https://arxiv.org/abs/2608.06213）
- [RecSys 2026] WatchLens: A Configurable Platform for Online Video Recommendation Experiments — 视频推荐在线实验的可配置平台，支持多策略快速切换与A/B测试（https://zhuanlan.zhihu.com/p/2068647125420970588）

**2026-07-19**
- [知乎] 推荐系统范式级重构综述：从DLRM时代（精排堆深/粗排蒸馏/序列建模）到新范式（TIGER/HSTU/MTGR/OneRec/RankMixer），精排正从判别式走向生成式，序列Transformer在工业级落地已成主流（https://www.zhihu.com/question/35248019/answer/2038710425735406661）
