...
**2026-09-17**
- [arxiv 2609.18148] LIGE-GR: A Smooth Leap from Ranking to Generative Recommendation in the LLM Era — 从判别式排序平滑过渡到生成式推荐的新框架，弥合传统排序与LLM生成式推荐之间的gap（https://arxiv.org/abs/2609.18148）
- [arxiv 2609.13993] P3Rec: Distilling Prior–Posterior Preference Reasoning for LLM-based Recommendation — 通过先验-后验偏好推理蒸馏提升LLM推荐能力（https://arxiv.org/abs/2609.13993）
- [arxiv 2409.09253] Unleash LLMs Potential for Sequential Recommendation by Coordinating Dual Dynamic Index Mechanism — 双动态索引机制释放LLM在序列推荐中的潜力（https://arxiv.org/abs/2409.09253）
- [arxiv 2609.17639] Scaling Articulated Rationales for MLLM-based Recommendation — 扩展多模态LLM推荐的可组合推理理由（https://arxiv.org/abs/2609.17639）
- [arxiv 2609.16560] ReliGRec: Reliability-Oriented LLM-Based Generative Recommendation via User-Risk-Aware Prompt Routing — 面向可靠性的生成式推荐，通过用户风险感知提示路由提升稳定性（https://arxiv.org/abs/2609.16560）
- [arxiv 2609.15598] Self-Evolving Memory for Generative Recommendation (CIKM'26) — 生成式推荐的自进化记忆机制（https://arxiv.org/abs/2609.15598）
- [arxiv 2609.16304] Evaluating Brand Retrieval and Ranking in Large Language Model Recommendations — 评估LLM推荐中品牌检索与排序能力（https://arxiv.org/abs/2609.16304）
